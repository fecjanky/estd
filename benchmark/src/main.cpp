...
try {
    ...
    std::istringstream(argv[1], std::istream::failbit | std::istream::badbit) >> num_of_elems;
    std::istringstream(argv[2], std::istream::failbit | std::istream::badbit) >> mult_factor;
